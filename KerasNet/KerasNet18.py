...
class GomokuNet18:
    ...
    def create_policy_value_net(self):
        ...
        # conv layers
        Conv1 = Conv2D(filters=64, kernel_size=(3, 3), padding='same', data_format="channels_first", activation="relu",
        ...
        Conv1 = Concatenate(axis=1)([Conv1, Conv])
        print(Conv1.shape)
        ...
        Conv1 = Concatenate(axis=1)([Conv1, Conv])
        print(Conv1.shape)
        Conv = Conv2D(filters=256, kernel_size=(3, 3), padding='same', data_format="channels_first", activation="relu",
                      kernel_regularizer=l2(self.l2_const))(Conv1)
        Conv = Conv2D(filters=256, kernel_size=(3, 3), padding='same', data_format="channels_first", activation="relu",
                      kernel_regularizer=l2(self.l2_const))(Conv)
        Conv1 = Concatenate(axis=1)([Conv1, Conv])
        print(Conv1.shape)
        Conv = Conv2D(filters=512, kernel_size=(3, 3), padding='same', data_format="channels_first", activation="relu",
                      kernel_regularizer=l2(self.l2_const))(Conv1)
        Conv = Conv2D(filters=512, kernel_size=(3, 3), padding='same', data_format="channels_first", activation="relu",
                      kernel_regularizer=l2(self.l2_const))(Conv)
        Conv = Concatenate(axis=1)([Conv1, Conv])
        print(Conv.shape)
